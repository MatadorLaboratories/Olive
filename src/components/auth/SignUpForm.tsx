...
export function SignUpForm({ next, compact }: { next?: string; compact?: boolean }) {
  ...
  return (
    <form action={onSubmit} className="space-y-5">
      ...
      <div>
        ...
        <input id="su-email" name="email" type="email" required autoComplete="email" placeholder="you@example.com" className="field-input" />
      </div>
      <div>
      ...
      <button type="submit" disabled={pending} className={cn("btn btn-clay w-full !py-4", pending && "opacity-70")}>
